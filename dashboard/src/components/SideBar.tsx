...
const SideBar = () => {
  ...
  return !user ? (
    ...
    <div className="hidden flex-[1] h-screen dark:text-blue-lagoon-100 lg:flex lg:flex-col lg:items-end lg:py-[200px] lg:pr-10">
      <div className="w-full max-w-[12rem] rounded-md flex flex-col mx-auto shadow-md gap-5 p-5 mt-6 bg-white/40 border border-blue-lagoon-500/20 dark:border-blue-lagoon-300/60 dark:hover:border-blue-lagoon-300 dark:bg-[#141414]">

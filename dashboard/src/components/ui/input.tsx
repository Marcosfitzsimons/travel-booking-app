...
after:pointer-events-none after:absolute after:inset-px after:rounded-[7px] after:shadow-highlight after:shadow-white/5 focus-within:after:shadow-blue-lagoon-200/40 after:transition dark:focus-within:after:shadow-blue-lagoon-300/40 dark:before:ring-blue-lagoon-500/20 dark:before:border-blue-lagoon-300"
        >
          <input
            className={cn(
              "w-full px-3.5 py-2 relative text-sm rounded-lg border border-blue-lagoon-700/50 bg-white placeholder:text-blue-lagoon-600 dark:border-blue-lagoon-500/20 dark:bg-black/80 dark:placeholder:text-blue-lagoon-100 dark:text-blue-lagoon-100 shadow-input shadow-black/10 !outline-none",
              className
            )}
            ref={ref}
            {...props}

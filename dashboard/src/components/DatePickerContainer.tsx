...
after:pointer-events-none after:absolute after:inset-px after:rounded-[7px] after:shadow-highlight after:shadow-white/5 focus-within:after:shadow-blue-lagoon-300/40 after:transition dark:focus-within:after:shadow-blue-lagoon-300/40 dark:before:ring-blue-lagoon-500/20 dark:before:border-blue-lagoon-300"
    >
      ...
      <DatePicker
        ...
        locale="es"
        className={`cursor-pointer w-full pl-10 font-medium rounded-lg border border-blue-lagoon-100/50 bg-white/80 shadow-input !outline-none shadow-blue-lagoon-500/10 dark:border-blue-lagoon-800/20 p-2 placeholder:text-blue-lagoon-700 dark:text-white dark:bg-blue-lagoon-300/10 dark:placeholder:text-white`}
        selected={startDate}

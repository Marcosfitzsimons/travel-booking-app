        ...
        <AnimatePresence mode="wait">
          {!isSuccess ? (
            ...
            <motion.div
              ...
              exit="exit"
              key="success"
              className="flex w-full flex-col items-center gap-4 mt-2 lg:self-start"
            >
              <div className="flex flex-col items-center gap-1">
                ...
                <p className="text-center text-card-foreground sm:w-9/12">
                  Acabamos de enviar un link de activación a tu correo
                  electrónico para identificar que te pertenece
                </p>
              </div>

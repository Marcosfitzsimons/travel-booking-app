...
const BackButton = ({ toProfile }: ButtonProps) => {
  return (
    <div className="relative after:absolute after:pointer-events-none after:inset-px after:rounded-[7px] dark:after:shadow-highlight dark:after:shadow-blue-lagoon-300/60 focus-within:after:shadow-[#77f6aa] after:transition dark:after:hover:shadow-blue-lagoon-300/80">

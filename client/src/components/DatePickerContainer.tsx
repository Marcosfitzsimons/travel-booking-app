...
after:pointer-events-none after:absolute after:inset-px after:rounded-[7px] after:shadow-highlight after:shadow-white/5 focus-within:after:shadow-blue-lagoon-300/40 after:transition dark:focus-within:after:shadow-blue-lagoon-300/40 dark:before:ring-blue-lagoon-500/20 dark:before:border-blue-lagoon-300"
    >
      <CalendarDays className="absolute left-3 w-5 h-5 z-50 dark:text-white" />
      <DatePicker
        dateFormat={"dd/MM/yyyy"}
        locale="es"
        className="cursor-pointer w-full pl-10 font-medium rounded-lg border border-blue-lagoon-100/50 bg-white/80 shadow-input !outline-none shadow-blue-lagoon-500/10 dark:border-blue-lagoon-800/20 p-2 dark:text-white dark:bg-blue-lagoon-300/10"
        selected={startDate}
        minDate={new Date()}
        InputProps={{
